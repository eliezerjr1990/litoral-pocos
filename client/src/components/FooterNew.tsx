        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          >
            ...
            <div className="space-y-3 text-blue-100 text-sm">
              <div>
                <p className="font-bold text-white">ATENDIMENTO PRINCIPAL</p>
                <p>(41) 98437-8485 (Eliezer)</p>
              </div>
              <div>
                <p className="font-bold text-white">AGENDAMENTOS</p>
                <p>(41) 99867-0421 (Anthonnelly)</p>
              </div>
              <div>
                <p className="font-bold text-white">TÉCNICO PERFURADOR</p>
